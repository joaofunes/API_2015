...
import com.gmorenosys.service.VentaService;
...
@ManagedBean
@SessionScoped
public class CompraVentaVehiculosMB implements Serializable{
    ...
    private void init() {
        ...
        listadoClientes = new ArrayList<Clientes>();
        setListadoNotario(notarioService.findAll()); 
    }
    
    public CompraVentaVehiculosMB() {
    ...
    public void inicializador(){
         try {
            if (notario != null) {
                setListadoClientes(clientesService.getAllClientesXNotario(notario.getIdnotario()));
            }
        } catch (Exception e) {
