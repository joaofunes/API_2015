...
public class PersistenceHibernateConfig {
    ...
    public LocalSessionFactoryBean alertsSessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.gmorenosys.model"});
...
//        ds.setUrl("jdbc:mysql://5.56.58.10:3306/gmorenosys");
//        ds.setUsername("gmorenosys");
//        ds.setPassword("s1ac0fing3s_UES");
        ds.setUrl("jdbc:mysql://localhost:3306/sipgdn");
        ds.setUsername("root");
       ds.setPassword("");
//        ds.setUsername("root");
